========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Sever
========================================================================


AppWizard has created this Sever application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Sever application.
...
res\Sever.ico
    ...
    icon is included by the main resource file Sever.rc.
...
SeverDlg.h, SeverDlg.cpp - the dialog
    These files contain your CSeverDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Sever.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CSeverDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Sever.pch and a precompiled types file named StdAfx.obj.
